          ...
          <div className="absolute inset-0 flex items-center justify-start p-4 sm:p-8 lg:p-12">
            <div className="max-w-xl">
              ...
              >
                ...
                <button className="px-4 sm:px-6 lg:px-8 py-2 sm:py-3 bg-orange-600 text-white font-bold rounded-lg hover:bg-orange-700 transition-all duration-300 flex items-center gap-2 inline-flex text-sm sm:text-base">
                  Mua ngay
